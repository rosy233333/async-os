...
impl W {}
#[doc = "Register receive target task.\n\nYou can [`read`](crate::Reg::read) this register and get [`register_recv_target_task::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`register_recv_target_task::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
