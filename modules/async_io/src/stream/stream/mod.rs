...
pub use for_each::ForEachFuture;
pub use fuse::Fuse;
pub use ge::GeFuture;
pub use gt::GtFuture;
pub use inspect::Inspect;
pub use last::LastFuture;
pub use le::LeFuture;
pub use lt::LtFuture;
pub use map::Map;
...
pub use partial_cmp::PartialCmpFuture;
...
pub trait Stream: AsyncStream {
    ...
    where
        ...
        S: AsyncStream,
        <Self as AsyncStream>::Item: PartialOrd<S::Item>,
    {
    ...
    where
        Self: Sized,
        S: Sized + AsyncStream,
        <Self as AsyncStream>::Item: PartialEq<S::Item>,
    {
...
impl<T: AsyncStream + ?Sized> Stream for T {}
