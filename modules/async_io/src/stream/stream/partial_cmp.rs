...
pin_project! {
    ...
    pub struct PartialCmpFuture<L: AsyncStream, R: AsyncStream> {
        #[pin]
        l: Fuse<L>,
        #[pin]
        r: Fuse<R>,
...
impl<L: AsyncStream, R: AsyncStream> PartialCmpFuture<L, R> {
...
impl<L: AsyncStream, R: AsyncStream> Future for PartialCmpFuture<L, R>
where
    L: AsyncStream + Sized,
    R: AsyncStream + Sized,
