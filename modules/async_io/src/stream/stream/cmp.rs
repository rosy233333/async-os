...
pin_project! {
    ...
    pub struct CmpFuture<L: AsyncStream, R: AsyncStream> {
        #[pin]
        l: Fuse<L>,
        #[pin]
        r: Fuse<R>,
...
impl<L: AsyncStream, R: AsyncStream> CmpFuture<L, R> {
...
impl<L: AsyncStream, R: AsyncStream> Future for CmpFuture<L, R>
where
    L: AsyncStream + Sized,
    R: AsyncStream<Item = L::Item> + Sized,
    L::Item: Ord,
{
