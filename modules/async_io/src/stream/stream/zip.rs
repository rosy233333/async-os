...
pin_project! {
    ...
    pub struct Zip<A: AsyncStream, B> {
...
impl<A: AsyncStream + fmt::Debug, B: fmt::Debug> fmt::Debug for Zip<A, B> {
...
impl<A: AsyncStream, B: AsyncStream> AsyncStream for Zip<A, B> {
